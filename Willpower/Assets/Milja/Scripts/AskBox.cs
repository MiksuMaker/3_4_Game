...
public class AskBox : MonoBehaviour
{
    ...
    private void initializeQuestions()
    {
        ...
        questionsTaenia.Add(("What are your future plans?", "I'll go back playing games. You remember? My dream of becoming a professional esport gamer?"));
        ...
        questionsTaenia.Add(("What do you think about my father?", "A senile old man. I always wished he'd at least get a phone and stop visiting our house every time he need helps with something ridiculous..."));
        ...
        questionsWillow.Add(("Your favorite hobby?", "I like running around the forest and collecting little bugs. I usually play that they are my family."));
        questionsWillow.Add(("Do you like school?", "Not really, my classmates only play hide and seek so I don't play with them. But I know it's important to study good."));
        ...
        //Mortti questions
        questionsMortti.Add(("What would you like to inherit?", "Oh? I only came since I heard about your condition, man. But if I could make a wish... Maybe your house? Our current house is way too small and poor."));
        ...
        questionsMortti.Add(("Do you remember how we became friends?", "Was it during our class trip to the zoo? We had to stay at school since I was allergic to all the animals and your father didn't want you to have any fun."));
        ...
        questionsMortti.Add(("?", "?"));
        questionsMortti.Add(("Are you sad about my death?", "You will always be my best buddy. Even though you have never called me. Or asked what I've been up to."));
        ...
        questionsFather.Add(("Don't you have anything else to do?", "I would love to be in my cottage reading books and listening to birds, so yes."));
        ...
        questionsFather.Add(("Do you remember Mortti?", "He was like a son I never had. I wish he had visited us more often."));
